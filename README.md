...
## Latest Release: v1.3.20 (b13200)

- **Standalone Package (Full Module)**: [`HyperDL-v1.3.20.zip`](https://github.com/itswill00/HyperDL-Release/releases/download/v1.3.20/HyperDL-v1.3.20.zip) (~44M)
  - Flashable in Magisk, KernelSU, or APatch.
  - Bundles isolated Bionic Python 3.14 runtime and hardware-accelerated FFmpeg.

- **Lightweight OTA Hot-Patch**: [`HyperDL-OTA-v1.3.20.zip`](https://github.com/itswill00/HyperDL-Release/releases/download/v1.3.20/HyperDL-OTA-v1.3.20.zip) (~184K)
